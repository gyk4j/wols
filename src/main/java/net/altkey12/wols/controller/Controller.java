...
import net.altkey12.wols.beans.setup.RegistrationRequest;
...
import net.altkey12.wols.net.DiagnosticsResultsBuilder;
import net.altkey12.wols.net.NetworkDiagnostics;
import net.altkey12.wols.net.NetworkDiagnosticsFactory;
import net.altkey12.wols.repository.CountryCodesRepository;
import net.altkey12.wols.repository.NetworkProfile;
import net.altkey12.wols.repository.UpdateRepository;
import net.altkey12.wols.repository.linux.NetworkManager;
import net.altkey12.wols.service.RegistrationService;
