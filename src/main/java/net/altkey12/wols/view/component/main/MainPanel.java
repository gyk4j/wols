...
import net.altkey12.wols.view.component.TabPage;
import net.altkey12.wols.view.component.contactus.ContactUsPage;
import net.altkey12.wols.view.component.faqs.FaqsPage;
import net.altkey12.wols.view.component.hotspots.HotspotsPage;
import net.altkey12.wols.view.component.news.NewsPage;
import net.altkey12.wols.view.component.privacypolicy.PrivacyPolicyPage;
import net.altkey12.wols.view.component.setup.SetupPage;
import net.altkey12.wols.view.component.speedtest.SpeedTestPage;
import net.altkey12.wols.view.component.termsandconditions.TermsAndConditionsPage;
import net.altkey12.wols.view.component.updatecontent.UpdateContentPage;
