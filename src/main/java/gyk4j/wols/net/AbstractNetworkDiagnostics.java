...
import gyk4j.wols.beans.speedtest.OutputWanIp;
import gyk4j.wols.beans.speedtest.SpeedTests;
import gyk4j.wols.util.SpeedTestsTool;
import gyk4j.wols.util.WanIpTool;

/**
 * For cross-platform system information gathering functions to be inherited and 
 * shared by other platform-specific 
 * {@link gyk4j.wols.net.NetworkDiagnostics NetworkDiagnostics}
 * implementations. 
 * @author user
 *
 */
